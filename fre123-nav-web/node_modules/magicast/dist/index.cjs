...
const SourceMapConsumer = sourceMap__default.SourceMapConsumer;
const SourceMapGenerator = sourceMap__default.SourceMapGenerator;
...
class Lines {
  ...
  getSourceMap(sourceMapName, sourceRoot) {
    ...
    const smg = new sourceMap__default.SourceMapGenerator(updateJSON());
    const sourcesToContents = {};
