...
export declare const NoScript: import("vue").DefineComponent<{
    ...
    [key: string]: any;
}>[] | null | undefined, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, import("vue").EmitsOptions, string, import("vue").PublicProps, Readonly<import("vue").ExtractPropTypes<{
    title: StringConstructor;
    body: BooleanConstructor;
    renderPriority: (StringConstructor | NumberConstructor)[];
    accesskey: StringConstructor;
...
export declare const Title: import("vue").DefineComponent<{
    ...
    [key: string]: any;
}>[] | null | undefined, {}, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, import("vue").EmitsOptions, string, import("vue").PublicProps, Readonly<import("vue").ExtractPropTypes<{
    readonly [x: string]: any;
}>>, {
    readonly [x: string]: any;
}, {}>;
