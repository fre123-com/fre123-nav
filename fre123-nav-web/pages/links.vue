 ...
 * @Date: 2024-08-18 15:20:28
 * @LastEditors: Damnnnnnnn yejianxin1116@gmail.com
 * @LastEditTime: 2024-08-18 17:28:54
 * 2024-08-18 15:20:28
-->
<template>
	<div class="link-container">
		...
		>
			<div v-for="group in linksData" class="link-container-category-item">
				<h2 class="text-primary-text leading-[25px] font-semibold text-[18px] mb-4">
					{{ group.name }}
				</h2>
...
import { CONFIG_BUSINESS_KEY_FRIENDSHIP_LINK, getBusinessConfig } from '~/stores/config'
