 ...
 * @Date: 2024-08-18 14:37:57
 * @LastEditors: Damnnnnnnn yejianxin1116@gmail.com
 * @LastEditTime: 2024-08-18 15:14:35
 * 2024-08-18 14:37:57
-->
<template>
	<div class="img-surprise-container">
		...
		>
			<img
				class="max-w-[200px] md:max-w-[300px] rounded-[10px] h-auto"
				:src="surprise.img_url"
				:alt="surprise.title"
			/>
		</component>
	</div>
...
<style scoped>
.img-surprise-container {
	@apply shadow-[0_4px_8px_rgba(0,0,0,0.1)] rounded-[10px]   border-[1px] border-[rgba(0,0,0,.125)] cursor-pointer;
}

.close-btn {
	@apply absolute top-[5px] right-[5px] cursor-pointer w-[22px] h-[22px] rounded-full bg-white hover:opacity-80 transition-all flex items-center justify-center hover:scale-110;
