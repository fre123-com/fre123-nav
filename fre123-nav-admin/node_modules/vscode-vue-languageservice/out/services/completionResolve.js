...
function register({ modules: { typescript: ts }, sourceFiles, getTsLs, vueHost, scriptTsLs }) {
    return async (item, newPosition) => {
        ...
        async function getTsResult(data) {
            ...
            const newVueItem = (0, transforms_1.transformCompletionItem)(data.tsItem, tsRange => { var _a; return (_a = sourceMap.getSourceRange(tsRange.start, tsRange.end)) === null || _a === void 0 ? void 0 : _a[0]; });
