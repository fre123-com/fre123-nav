...
const workspaceSymbol = require("./services/workspaceSymbol");
...
function createLanguageService(modules, vueHost, isTsPlugin = false) {
    ...
    const isVue2 = ((_a = vueHost.getVueCompilationSettings) === null || _a === void 0 ? void 0 : _a.call(vueHost).experimentalCompatMode) === 2;
    ...
    const documentContext = {
        resolveReference(ref, base) {
            ...
            const resolveResult = ts.resolveModuleName(ref, isUri ? shared.uriToFsPath(base) : base, vueHost.getCompilationSettings(), compilerHost);
            const failedLookupLocations = resolveResult.failedLookupLocations;
            const dirs = new Set();
            const fileExists = (_a = vueHost.fileExists) !== null && _a !== void 0 ? _a : ts.sys.fileExists;
            const directoryExists = (_b = vueHost.directoryExists) !== null && _b !== void 0 ? _b : ts.sys.directoryExists;
    ...
    const context = {
        compilerOptions: (_c = (_b = vueHost.getVueCompilationSettings) === null || _b === void 0 ? void 0 : _b.call(vueHost)) !== null && _c !== void 0 ? _c : {},
        modules: {
            typescript: modules.typescript,
            emmet,
            css,
...
function createServices(ts, vueHost) {
    ...
    function updateHtmlCustomData(customData) {
        htmlDataProviders = [];
    ...
    function updateCssCustomData(customData) {
