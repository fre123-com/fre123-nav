...
var TRANSFORM_LOADER = resolve3(_dirname, "webpack/loaders/transform.js");
var LOAD_LOADER = resolve3(_dirname, "webpack/loaders/load.js");
  ...
  return (userOptions) => {
    return {
      apply(compiler) {
        ...
        const virtualModulePrefix = resolve3(process.cwd(), "_virtual_");
        const rawPlugin = factory(userOptions, meta);
        ...
        compiler.hooks.thisCompilation.tap(plugin.name, (compilation) => {
          ...
          (_a = plugin.buildStart) == null ? void 0 : _a.call({
            addWatchFile(id) {
              var _a2;
              ((_a2 = compilation.fileDependencies) != null ? _a2 : compilation.compilationDependencies).add(resolve3(process.cwd(), id));
            },
            emitFile(emittedFile) {
              var _a2;
              const outFileName = emittedFile.fileName || emittedFile.name;
