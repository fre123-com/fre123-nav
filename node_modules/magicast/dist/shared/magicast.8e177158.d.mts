...
export { type CodeFormatOptions as C, type GenerateOptions as G, type ImportItemInput as I, type Loc as L, type Options as O, type ProxifiedModule as P, type Token as T, type Proxified as a, type ParsedFileNode as b, type ProxyBase as c, type ProxifiedArray as d, type ProxifiedFunctionCall as e, type ProxifiedNewExpression as f, type ProxifiedObject as g, type ProxifiedIdentifier as h, type ProxifiedImportsMap as i, type ProxifiedImportItem as j, type ProxifiedValue as k, type ProxyType as l, detectCodeFormat as m };
